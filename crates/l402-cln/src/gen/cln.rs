...
pub struct AutocleanonceAutoclean {
    ...
    pub networkevents: ::core::option::Option<AutocleanonceAutocleanNetworkevents>,
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
...
pub struct AutocleanstatusAutoclean {
    ...
    #[prost(message, optional, tag = "7")]
    pub networkevents: ::core::option::Option<AutocleanstatusAutocleanNetworkevents>,
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
...
pub struct RecoverResponse {
    #[prost(enumeration = "recover_response::RecoverResult", tag = "1")]
    pub result: i32,
}
...
pub struct SendonionRequest {
    ...
    pub description: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(message, optional, tag = "15")]
    pub total_amount_msat: ::core::option::Option<Amount>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct ListpeerchannelsChannels {
    ...
    #[prost(sint64, optional, tag = "60")]
    pub direction: ::core::option::Option<i64>,
...
pub struct ListpeerchannelsChannelsFunding {
    ...
    pub withheld: ::core::option::Option<bool>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct ListclosedchannelsClosedchannels {
    ...
    pub funding_psbt: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(bool, optional, tag = "27")]
    pub funding_withheld: ::core::option::Option<bool>,
}
...
pub struct FeeratesPerkb {
    ...
    pub splice: ::core::option::Option<u32>,
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
...
pub struct Fetchbip353Response {
    ...
    #[prost(message, repeated, tag = "2")]
    pub instructions: ::prost::alloc::vec::Vec<Fetchbip353Instructions>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Fetchbip353Instructions {
    ...
    pub description: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag = "2")]
    pub offer: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag = "3")]
    pub onchain: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(uint64, optional, tag = "4")]
    pub offchain_amount_msat: ::core::option::Option<u64>,
    #[prost(uint64, optional, tag = "5")]
    pub onchain_amount_sat: ::core::option::Option<u64>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct CancelrecurringinvoiceRequest {
    ...
    #[prost(string, tag = "3")]
    pub recurrence_label: ::prost::alloc::string::String,
    #[prost(double, optional, tag = "4")]
    pub recurrence_start: ::core::option::Option<f64>,
    #[prost(string, optional, tag = "5")]
    pub payer_note: ::core::option::Option<::prost::alloc::string::String>,
...
pub struct FundchannelCompleteRequest {
    ...
    pub psbt: ::prost::alloc::string::String,
    #[prost(bool, optional, tag = "3")]
    pub withhold: ::core::option::Option<bool>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct ListhtlcsRequest {
    ...
    #[prost(enumeration = "listhtlcs_request::ListhtlcsIndex", optional, tag = "2")]
    pub index: ::core::option::Option<i32>,
    #[prost(uint64, optional, tag = "3")]
    pub start: ::core::option::Option<u64>,
    #[prost(uint32, optional, tag = "4")]
...
/// Nested message and enum types in `ListhtlcsRequest`.
pub mod listhtlcs_request {
    /// ListHtlcs.index
    #[derive(
        Clone,
        Copy,
...
pub struct OfferRequest {
    ...
    pub optional_recurrence: ::core::option::Option<bool>,
    #[prost(bytes = "vec", repeated, tag = "15")]
    pub fronting_nodes: ::prost::alloc::vec::Vec<::prost::alloc::vec::Vec<u8>>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
    ...
    impl WaitSubsystem {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::Htlcs => "HTLCS",
                Self::Chainmoves => "CHAINMOVES",
                Self::Channelmoves => "CHANNELMOVES",
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "HTLCS" => Some(Self::Htlcs),
                "CHAINMOVES" => Some(Self::Chainmoves),
                "CHANNELMOVES" => Some(Self::Channelmoves),
                "NETWORKEVENTS" => Some(Self::Networkevents),
                _ => None,
            }
        }
    }
...
pub struct WaitResponse {
    ...
    #[prost(message, optional, tag = "6")]
    pub forwards: ::core::option::Option<WaitForwards>,
    #[prost(message, optional, tag = "7")]
    pub invoices: ::core::option::Option<WaitInvoices>,
    #[prost(message, optional, tag = "8")]
    pub sendpays: ::core::option::Option<WaitSendpays>,
    #[prost(message, optional, tag = "9")]
    pub htlcs: ::core::option::Option<WaitHtlcs>,
    #[prost(message, optional, tag = "10")]
    pub chainmoves: ::core::option::Option<WaitChainmoves>,
    #[prost(message, optional, tag = "11")]
    pub channelmoves: ::core::option::Option<WaitChannelmoves>,
    #[prost(message, optional, tag = "12")]
    pub networkevents: ::core::option::Option<WaitNetworkevents>,
}
...
pub struct WaitForwards {
    #[prost(enumeration = "wait_forwards::WaitForwardsStatus", optional, tag = "1")]
    pub status: ::core::option::Option<i32>,
    #[prost(string, optional, tag = "2")]
    pub in_channel: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(uint64, optional, tag = "3")]
...
/// Nested message and enum types in `WaitForwards`.
pub mod wait_forwards {
...
pub struct WaitInvoices {
    #[prost(enumeration = "wait_invoices::WaitInvoicesStatus", optional, tag = "1")]
    pub status: ::core::option::Option<i32>,
    #[prost(string, optional, tag = "2")]
    pub label: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag = "3")]
...
/// Nested message and enum types in `WaitInvoices`.
pub mod wait_invoices {
...
pub struct WaitSendpays {
    #[prost(enumeration = "wait_sendpays::WaitSendpaysStatus", optional, tag = "1")]
    pub status: ::core::option::Option<i32>,
    #[prost(uint64, optional, tag = "2")]
    pub partid: ::core::option::Option<u64>,
    #[prost(uint64, optional, tag = "3")]
...
/// Nested message and enum types in `WaitSendpays`.
pub mod wait_sendpays {
...
pub struct WaitHtlcs {
    #[prost(enumeration = "HtlcState", optional, tag = "1")]
    ...
    pub short_channel_id: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(uint32, optional, tag = "4")]
    pub cltv_expiry: ::core::option::Option<u32>,
    #[prost(message, optional, tag = "5")]
    pub amount_msat: ::core::option::Option<Amount>,
    #[prost(enumeration = "wait_htlcs::WaitHtlcsDirection", optional, tag = "6")]
    pub direction: ::core::option::Option<i32>,
    #[prost(bytes = "vec", optional, tag = "7")]
    pub payment_hash: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
}
/// Nested message and enum types in `WaitHtlcs`.
pub mod wait_htlcs {
...
pub struct WaitNetworkevents {
    ...
    pub created_index: ::core::option::Option<u64>,
    #[prost(
        enumeration = "wait_networkevents::WaitNetworkeventsType",
        optional,
        tag = "2"
    )]
...
/// Nested message and enum types in `WaitNetworkevents`.
pub mod wait_networkevents {
...
pub struct ListconfigsConfigs {
    ...
    pub currencyrate_add_source: ::core::option::Option<
        ListconfigsConfigsCurrencyrateaddsource,
    >,
    #[prost(message, optional, tag = "75")]
    pub currencyrate_disable_source: ::core::option::Option<
        ListconfigsConfigsCurrencyratedisablesource,
    >,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct StopResponse {
    #[prost(enumeration = "stop_response::StopResult", tag = "1")]
    pub result: i32,
}
...
pub struct AskreneunreserveRequest {
    ...
    #[prost(bool, optional, tag = "2")]
    pub dev_remove_all: ::core::option::Option<bool>,
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
...
pub struct AskrenelistlayersLayers {
    ...
    #[prost(message, repeated, tag = "9")]
    pub node_biases: ::prost::alloc::vec::Vec<AskrenelistlayersLayersNodeBiases>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct AskrenecreatelayerLayers {
    ...
    #[prost(message, repeated, tag = "9")]
    pub node_biases: ::prost::alloc::vec::Vec<AskrenecreatelayerLayersNodeBiases>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct GetroutesRequest {
    ...
    pub maxdelay: ::core::option::Option<u32>,
    #[prost(uint32, optional, tag = "9")]
    pub maxparts: ::core::option::Option<u32>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct AskrenebiasnodeResponse {
    #[prost(message, repeated, tag = "1")]
    pub node_biases: ::prost::alloc::vec::Vec<AskrenebiasnodeNodeBiases>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct ListchannelmovesRequest {
    #[prost(
        enumeration = "listchannelmoves_request::ListchannelmovesIndex",
        optional,
        tag = "1"
    )]
    pub index: ::core::option::Option<i32>,
...
/// Nested message and enum types in `ListchannelmovesRequest`.
pub mod listchannelmoves_request {
...
pub struct ListchannelmovesResponse {
    #[prost(message, repeated, tag = "1")]
    pub channelmoves: ::prost::alloc::vec::Vec<ListchannelmovesChannelmoves>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ListchannelmovesChannelmoves {
    ...
    pub timestamp: u64,
    #[prost(
        enumeration = "listchannelmoves_channelmoves::ListchannelmovesChannelmovesPrimaryTag",
        tag = "6"
    )]
    pub primary_tag: i32,
    #[prost(bytes = "vec", optional, tag = "7")]
    pub payment_hash: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
    #[prost(uint64, optional, tag = "8")]
    pub part_id: ::core::option::Option<u64>,
    #[prost(uint64, optional, tag = "9")]
    pub group_id: ::core::option::Option<u64>,
    #[prost(message, optional, tag = "10")]
    pub fees_msat: ::core::option::Option<Amount>,
}
/// Nested message and enum types in `ListchannelmovesChannelmoves`.
pub mod listchannelmoves_channelmoves {
    ...
    impl ListchannelmovesChannelmovesPrimaryTag {
        /// String value of the enum field names used in the ProtoBuf definition.
        ///
        /// The values are not transformed in any way and thus are considered stable
        /// (if the ProtoBuf definition does not change) and safe for programmatic use.
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::Routed => "ROUTED",
                Self::Pushed => "PUSHED",
                Self::LeaseFee => "LEASE_FEE",
                Self::ChannelProposed => "CHANNEL_PROPOSED",
                Self::PenaltyAdj => "PENALTY_ADJ",
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "LEASE_FEE" => Some(Self::LeaseFee),
                "CHANNEL_PROPOSED" => Some(Self::ChannelProposed),
                "PENALTY_ADJ" => Some(Self::PenaltyAdj),
...
pub struct ListchainmovesRequest {
    #[prost(
        enumeration = "listchainmoves_request::ListchainmovesIndex",
        optional,
        tag = "1"
    )]
    pub index: ::core::option::Option<i32>,
...
/// Nested message and enum types in `ListchainmovesRequest`.
pub mod listchainmoves_request {
...
pub struct ListchainmovesResponse {
    #[prost(message, repeated, tag = "1")]
    pub chainmoves: ::prost::alloc::vec::Vec<ListchainmovesChainmoves>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ListchainmovesChainmoves {
    ...
    pub timestamp: u64,
    #[prost(
        enumeration = "listchainmoves_chainmoves::ListchainmovesChainmovesPrimaryTag",
        tag = "6"
    )]
    pub primary_tag: i32,
    #[prost(bytes = "vec", optional, tag = "8")]
    ...
    pub spending_txid: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
    #[prost(message, optional, tag = "11")]
    pub utxo: ::core::option::Option<Outpoint>,
    #[prost(bytes = "vec", optional, tag = "12")]
    pub payment_hash: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
    #[prost(message, optional, tag = "13")]
    pub output_msat: ::core::option::Option<Amount>,
    #[prost(uint32, optional, tag = "14")]
    pub output_count: ::core::option::Option<u32>,
    #[prost(uint32, tag = "15")]
    pub blockheight: u32,
    #[prost(string, repeated, tag = "16")]
    pub extra_tags: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
}
/// Nested message and enum types in `ListchainmovesChainmoves`.
pub mod listchainmoves_chainmoves {
    ...
    impl ListchainmovesChainmovesPrimaryTag {
        /// String value of the enum field names used in the ProtoBuf definition.
        ///
        /// The values are not transformed in any way and thus are considered stable
        /// (if the ProtoBuf definition does not change) and safe for programmatic use.
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::DelayedToUs => "DELAYED_TO_US",
                Self::HtlcTx => "HTLC_TX",
                Self::HtlcTimeout => "HTLC_TIMEOUT",
                Self::HtlcFulfill => "HTLC_FULFILL",
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "DELAYED_TO_US" => Some(Self::DelayedToUs),
                "HTLC_TX" => Some(Self::HtlcTx),
                "HTLC_TIMEOUT" => Some(Self::HtlcTimeout),
                "HTLC_FULFILL" => Some(Self::HtlcFulfill),
                "TO_WALLET" => Some(Self::ToWallet),
                "ANCHOR" => Some(Self::Anchor),
                "TO_THEM" => Some(Self::ToThem),
                "PENALIZED" => Some(Self::Penalized),
                "STOLEN" => Some(Self::Stolen),
                "IGNORED" => Some(Self::Ignored),
                "TO_MINER" => Some(Self::ToMiner),
                _ => None,
            }
        }
    }
...
pub struct ListnetworkeventsRequest {
    ...
    pub id: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(
        enumeration = "listnetworkevents_request::ListnetworkeventsIndex",
        optional,
        tag = "2"
    )]
    pub index: ::core::option::Option<i32>,
...
/// Nested message and enum types in `ListnetworkeventsRequest`.
pub mod listnetworkevents_request {
...
pub struct ListnetworkeventsResponse {
    #[prost(message, repeated, tag = "1")]
    pub networkevents: ::prost::alloc::vec::Vec<ListnetworkeventsNetworkevents>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ListnetworkeventsNetworkevents {
    ...
    #[prost(uint64, optional, tag = "6")]
    pub duration_nsec: ::core::option::Option<u64>,
    #[prost(bool, optional, tag = "7")]
    pub connect_attempted: ::core::option::Option<bool>,
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
...
pub struct ClnrestregisterpathRequest {
    ...
    #[prost(message, optional, tag = "3")]
    pub rune_restrictions: ::core::option::Option<ClnrestregisterpathRuneRestrictions>,
    #[prost(bool, optional, tag = "4")]
    pub rune_required: ::core::option::Option<bool>,
    #[prost(string, optional, tag = "5")]
...
pub struct ChannelStateChangedNotification {
    ...
    #[prost(enumeration = "ChannelState", optional, tag = "5")]
...
pub mod node_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn fetch_bip353(
            &mut self,
            request: impl tonic::IntoRequest<super::Fetchbip353Request>,
        ) -> std::result::Result<
            tonic::Response<super::Fetchbip353Response>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/cln.Node/FetchBip353");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("cln.Node", "FetchBip353"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn cancel_recurring_invoice(
            &mut self,
            request: impl tonic::IntoRequest<super::CancelrecurringinvoiceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CancelrecurringinvoiceResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("cln.Node", "CancelRecurringInvoice"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn askrene_bias_node(
            &mut self,
            request: impl tonic::IntoRequest<super::AskrenebiasnodeRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AskrenebiasnodeResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/cln.Node/AskreneBiasNode");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("cln.Node", "AskreneBiasNode"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn sign_message_with_key(
            &mut self,
            request: impl tonic::IntoRequest<super::SignmessagewithkeyRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SignmessagewithkeyResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("cln.Node", "SignMessageWithKey"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn list_channel_moves(
            &mut self,
            request: impl tonic::IntoRequest<super::ListchannelmovesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListchannelmovesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("cln.Node", "ListChannelMoves"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn list_chain_moves(
            &mut self,
            request: impl tonic::IntoRequest<super::ListchainmovesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListchainmovesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/cln.Node/ListChainMoves");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("cln.Node", "ListChainMoves"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn list_network_events(
            &mut self,
            request: impl tonic::IntoRequest<super::ListnetworkeventsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListnetworkeventsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("cln.Node", "ListNetworkEvents"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn del_network_event(
            &mut self,
            request: impl tonic::IntoRequest<super::DelnetworkeventRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DelnetworkeventResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/cln.Node/DelNetworkEvent");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("cln.Node", "DelNetworkEvent"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn clnrest_register_path(
            &mut self,
            request: impl tonic::IntoRequest<super::ClnrestregisterpathRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ClnrestregisterpathResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("cln.Node", "ClnrestRegisterPath"));
            self.inner.unary(req, path, codec).await
        }
