<div align="center">
  ...
  <p>
    <strong>WebAssembly bindings for the L402sdk L402 client SDK</strong>
  </p>

  <p>
    <a href="https://www.npmjs.com/package/@lightninglabs/l402"><img alt="npm" src="https://img.shields.io/npm/v/@lightninglabs/l402.svg"/></a>
    <a href="https://www.npmjs.com/package/@lightninglabs/l402"><img alt="npm downloads" src="https://img.shields.io/npm/dm/@lightninglabs/l402.svg"/></a>
...
l402-wasm compiles the Rust L402 protocol engine to WebAssembly via `wasm-pack`, providing:
...
# Build for web
wasm-pack build crates/l402-wasm --target web

# Build for Node.js
wasm-pack build crates/l402-wasm --target nodejs

# Build for bundlers (webpack, etc.)
wasm-pack build crates/l402-wasm --target bundler
```
...
```bash
# Native unit tests
cargo test -p l402-wasm

# WASM browser tests (requires Chrome/Firefox)
wasm-pack test --headless --chrome crates/l402-wasm
```

## Architecture

l402-wasm provides the real Rust L402 client and backend adapters over `wasm-bindgen`:
