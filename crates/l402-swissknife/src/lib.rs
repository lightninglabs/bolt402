//! # l402-swissknife
//!
//! SwissKnife REST API backend adapter for the L402sdk L402 client SDK.
//!
//! This crate implements the [`l402_proto::LnBackend`] trait using
...
//! `l402-core` for the [`l402_proto::LnBackend`] port trait and uses
